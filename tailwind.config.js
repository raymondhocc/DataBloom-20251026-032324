...
export default {
  ...
  theme: {
  	extend: {
        ...
        'illustrative-green': 'hsl(var(--illustrative-green))',
        ...
        'shadow-illustrative': '0 10px 25px -5px rgba(0, 0, 0, 0.1), 0 8px 10px -6px rgba(0, 0, 0, 0.1)',
        'shadow-glass-accent': '0 4px 30px rgba(0, 0, 0, 0.1)',
  		},
  		keyframes: {
  			'fade-in': {
  		...
  		backgroundImage: {
  			'btn-gradient': 'linear-gradient(to right, hsl(var(--primary-accent)), hsl(var(--secondary-accent)))',
